...
export default function HomePage() {
  ...
  const charityCasinoNightDrinks = [
    <img
      key={1}
      src='/images/Mootropolis Milk Munch.svg'
      alt='Mootropolis Milk Munch card'
    />,
    <img key={2} src='/images/lime_bg.png' alt='Mootropolis Milk Munch card' />,
    <img
      key={3}
      src='/images/process_medium.png'
      alt='Mootropolis Milk Munch card'
    />,
  ];
  ...
  return (
    <main className='bg-background'>
      ...
      {/* <Header /> */}
      <Logo />
      <Modal enabled={modalEnabled} disable={disableModal}>
        <div className='text-[#800000]'>
          <button
            onClick={() => disableModal()}
            className={'text-[#800000] ' + dela_gothic_one.className}
          >
            ← All drinks
          </button>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <img
              className='order-2 md:order-1 row-span-2'
              src='/images/Mootropolis Milk Munch.svg'
              alt='Mootropolis Milk Munch card'
            />
            <div className='order-1 md:order-2 text-[#800000] '>
              <div className='flex'>
                <div className='p-3 mx-1 justify-center align-middle rounded-[100px] border-[#800000] border-[1px]'>
                  Sweet
                </div>
                <div className='p-3 mx-1 justify-center align-middle rounded-[100px] border-[#800000] border-[1px]'>
                  Tart
              ...
              <div className={'text-5xl ' + caveat.className}>
                Mootropolis Milk Munch
              </div>
            </div>
            <div className='order-3'>
              ...
              <div className={'text-2xl ' + comfortaa.className}>
                Ingredients
              </div>
          ...
          <div className={'text-2xl text-center ' + dela_gothic_one.className}>
            More drinks
          </div>
        ...
        <div className='layout relative flex flex-col w-full max-w-full'>
          ...
          <div className='border-b-8 border-[#57EFFF] bg-[#00245B] rounded-b-[80px] lg:rounded-b-[160px] mb-[-80px] lg:mb-[-160px] w-screen px-10 py-20 lg:p-[120px] z-[1] overflow-clip'>
            ...
            <div className='w-full text-center'>
              <CarouselArc
                items={charityCasinoNightDrinks}
          ...
          <div className='border-b-8 border-[#C7FF57] bg-[#254924] rounded-b-[80px] lg:rounded-b-[160px] mb-[-80px] lg:mb-[-160px] pt-[200px] lg:pt-[280px] w-screen px-10 py-20 lg:p-[120px] z-0 overflow-clip'>
            <div className='w-full text-center px-8 pb-4 sm:pb-10'>
              <span
                className={
                  'font-bold text-[#C7FF57] text-7xl sm:text-5xl ' +
